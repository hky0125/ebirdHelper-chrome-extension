...
with open(Path(r"map\map_bird_eng2chs.json"), "r", encoding="utf-8") as f:
...
ebird_excel = Path(r"birdsheet\eBird_taxonomy_v2025.xlsx")
df = pd.read_excel(ebird_excel)
...
# 3. 存成 json 文件
with open(r"map\map_pinyin.json", "w", encoding="utf-8") as f:
    json.dump(mapping, f, ensure_ascii=False, indent=4)

print(r"Done, written to map\map_pinyin.json")